...
// Dependency Injection module providing the necessary dependence for testing
@Module
...
object TestAppModule {
    ...
    @Provides
    @Singleton
    fun provideFakeNewsArticleRepository(
        api: NewsApiService,
    ): NewsArticleRepository {
        return com.example.newsapi.feature_topHeadlines.data.repository.FakeNewsArticleRepositoryImplementation()
    }
